...
<div class="rounden-full grid h-screen place-items-center fixed top-0 left-0 right-0 z-50 w-full bg-navgrey bg-opacity-50 p-4 overflow-y-auto h-full md:h-full sm:h-full hidden" style="border: 1px solid black" id="updateModal">
    <div class="shadow-lg bg-white w-96 h-3/4 grid h-screen" style="border: 2px solid #00acee; border-radius: 20px;">
        <div class=" overflow-x-auto overflow-auto">
                ...
                <div class="flex-auto m-1 w-50 text-left mt-5">
                    ...
                    <div>
                        <button class="w-1/2 rounded-full w-1/2 p-2 bg-buttonbg hover:bg-blue" style="border: 3px solid #00acee">Update Product</button>
                    </div>
